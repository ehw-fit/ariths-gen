...
uint64_t u_wallace_cla4(uint64_t a, uint64_t b){
  uint8_t u_wallace_cla4_out = 0;
  uint8_t u_wallace_cla4_and_2_0 = 0;
  uint8_t u_wallace_cla4_and_1_1 = 0;
  uint8_t u_wallace_cla4_ha0_xor0 = 0;
  uint8_t u_wallace_cla4_ha0_and0 = 0;
  uint8_t u_wallace_cla4_and_3_0 = 0;
  uint8_t u_wallace_cla4_and_2_1 = 0;
  uint8_t u_wallace_cla4_fa0_xor1 = 0;
  uint8_t u_wallace_cla4_fa0_or0 = 0;
  uint8_t u_wallace_cla4_and_3_1 = 0;
  uint8_t u_wallace_cla4_and_2_2 = 0;
  uint8_t u_wallace_cla4_fa1_xor1 = 0;
  uint8_t u_wallace_cla4_fa1_or0 = 0;
  uint8_t u_wallace_cla4_and_1_2 = 0;
  uint8_t u_wallace_cla4_and_0_3 = 0;
  uint8_t u_wallace_cla4_ha1_xor0 = 0;
  uint8_t u_wallace_cla4_ha1_and0 = 0;
  uint8_t u_wallace_cla4_and_1_3 = 0;
  uint8_t u_wallace_cla4_ha2_xor0 = 0;
  uint8_t u_wallace_cla4_ha2_and0 = 0;
  uint8_t u_wallace_cla4_and_3_2 = 0;
  uint8_t u_wallace_cla4_fa2_xor1 = 0;
  uint8_t u_wallace_cla4_fa2_or0 = 0;
  uint8_t u_wallace_cla4_and_0_0 = 0;
  uint8_t u_wallace_cla4_and_1_0 = 0;
  uint8_t u_wallace_cla4_and_0_2 = 0;
  uint8_t u_wallace_cla4_and_2_3 = 0;
  uint8_t u_wallace_cla4_and_0_1 = 0;
  uint8_t u_wallace_cla4_and_3_3 = 0;
  uint64_t u_wallace_cla4_u_cla6_a = 0;
  uint64_t u_wallace_cla4_u_cla6_b = 0;
  uint64_t u_wallace_cla4_u_cla6_out = 0;

  u_wallace_cla4_and_2_0 = and_gate(((a >> 2) & 0x01), ((b >> 0) & 0x01));
  u_wallace_cla4_and_1_1 = and_gate(((a >> 1) & 0x01), ((b >> 1) & 0x01));
  u_wallace_cla4_ha0_xor0 = (ha(((u_wallace_cla4_and_2_0 >> 0) & 0x01), ((u_wallace_cla4_and_1_1 >> 0) & 0x01)) >> 0) & 0x01;
  u_wallace_cla4_ha0_and0 = (ha(((u_wallace_cla4_and_2_0 >> 0) & 0x01), ((u_wallace_cla4_and_1_1 >> 0) & 0x01)) >> 1) & 0x01;
  u_wallace_cla4_and_3_0 = and_gate(((a >> 3) & 0x01), ((b >> 0) & 0x01));
  u_wallace_cla4_and_2_1 = and_gate(((a >> 2) & 0x01), ((b >> 1) & 0x01));
  u_wallace_cla4_fa0_xor1 = (fa(((u_wallace_cla4_ha0_and0 >> 0) & 0x01), ((u_wallace_cla4_and_3_0 >> 0) & 0x01), ((u_wallace_cla4_and_2_1 >> 0) & 0x01)) >> 0) & 0x01;
  u_wallace_cla4_fa0_or0 = (fa(((u_wallace_cla4_ha0_and0 >> 0) & 0x01), ((u_wallace_cla4_and_3_0 >> 0) & 0x01), ((u_wallace_cla4_and_2_1 >> 0) & 0x01)) >> 1) & 0x01;
  u_wallace_cla4_and_3_1 = and_gate(((a >> 3) & 0x01), ((b >> 1) & 0x01));
  u_wallace_cla4_and_2_2 = and_gate(((a >> 2) & 0x01), ((b >> 2) & 0x01));
  u_wallace_cla4_fa1_xor1 = (fa(((u_wallace_cla4_fa0_or0 >> 0) & 0x01), ((u_wallace_cla4_and_3_1 >> 0) & 0x01), ((u_wallace_cla4_and_2_2 >> 0) & 0x01)) >> 0) & 0x01;
  u_wallace_cla4_fa1_or0 = (fa(((u_wallace_cla4_fa0_or0 >> 0) & 0x01), ((u_wallace_cla4_and_3_1 >> 0) & 0x01), ((u_wallace_cla4_and_2_2 >> 0) & 0x01)) >> 1) & 0x01;
  u_wallace_cla4_and_1_2 = and_gate(((a >> 1) & 0x01), ((b >> 2) & 0x01));
  u_wallace_cla4_and_0_3 = and_gate(((a >> 0) & 0x01), ((b >> 3) & 0x01));
  u_wallace_cla4_ha1_xor0 = (ha(((u_wallace_cla4_and_1_2 >> 0) & 0x01), ((u_wallace_cla4_and_0_3 >> 0) & 0x01)) >> 0) & 0x01;
  u_wallace_cla4_ha1_and0 = (ha(((u_wallace_cla4_and_1_2 >> 0) & 0x01), ((u_wallace_cla4_and_0_3 >> 0) & 0x01)) >> 1) & 0x01;
  u_wallace_cla4_and_1_3 = and_gate(((a >> 1) & 0x01), ((b >> 3) & 0x01));
  u_wallace_cla4_ha2_xor0 = (ha(((u_wallace_cla4_ha1_and0 >> 0) & 0x01), ((u_wallace_cla4_and_1_3 >> 0) & 0x01)) >> 0) & 0x01;
  u_wallace_cla4_ha2_and0 = (ha(((u_wallace_cla4_ha1_and0 >> 0) & 0x01), ((u_wallace_cla4_and_1_3 >> 0) & 0x01)) >> 1) & 0x01;
  u_wallace_cla4_and_3_2 = and_gate(((a >> 3) & 0x01), ((b >> 2) & 0x01));
  u_wallace_cla4_fa2_xor1 = (fa(((u_wallace_cla4_ha2_and0 >> 0) & 0x01), ((u_wallace_cla4_fa1_or0 >> 0) & 0x01), ((u_wallace_cla4_and_3_2 >> 0) & 0x01)) >> 0) & 0x01;
  u_wallace_cla4_fa2_or0 = (fa(((u_wallace_cla4_ha2_and0 >> 0) & 0x01), ((u_wallace_cla4_fa1_or0 >> 0) & 0x01), ((u_wallace_cla4_and_3_2 >> 0) & 0x01)) >> 1) & 0x01;
  u_wallace_cla4_and_0_0 = and_gate(((a >> 0) & 0x01), ((b >> 0) & 0x01));
  u_wallace_cla4_and_1_0 = and_gate(((a >> 1) & 0x01), ((b >> 0) & 0x01));
  u_wallace_cla4_and_0_2 = and_gate(((a >> 0) & 0x01), ((b >> 2) & 0x01));
  u_wallace_cla4_and_2_3 = and_gate(((a >> 2) & 0x01), ((b >> 3) & 0x01));
  u_wallace_cla4_and_0_1 = and_gate(((a >> 0) & 0x01), ((b >> 1) & 0x01));
  u_wallace_cla4_and_3_3 = and_gate(((a >> 3) & 0x01), ((b >> 3) & 0x01));
  u_wallace_cla4_u_cla6_a |= ((u_wallace_cla4_and_1_0 >> 0) & 0x01ull) << 0;
  u_wallace_cla4_u_cla6_a |= ((u_wallace_cla4_and_0_2 >> 0) & 0x01ull) << 1;
  u_wallace_cla4_u_cla6_a |= ((u_wallace_cla4_fa0_xor1 >> 0) & 0x01ull) << 2;
  u_wallace_cla4_u_cla6_a |= ((u_wallace_cla4_fa1_xor1 >> 0) & 0x01ull) << 3;
  u_wallace_cla4_u_cla6_a |= ((u_wallace_cla4_and_2_3 >> 0) & 0x01ull) << 4;
  u_wallace_cla4_u_cla6_a |= ((u_wallace_cla4_fa2_or0 >> 0) & 0x01ull) << 5;
  u_wallace_cla4_u_cla6_b |= ((u_wallace_cla4_and_0_1 >> 0) & 0x01ull) << 0;
  u_wallace_cla4_u_cla6_b |= ((u_wallace_cla4_ha0_xor0 >> 0) & 0x01ull) << 1;
  u_wallace_cla4_u_cla6_b |= ((u_wallace_cla4_ha1_xor0 >> 0) & 0x01ull) << 2;
  u_wallace_cla4_u_cla6_b |= ((u_wallace_cla4_ha2_xor0 >> 0) & 0x01ull) << 3;
  u_wallace_cla4_u_cla6_b |= ((u_wallace_cla4_fa2_xor1 >> 0) & 0x01ull) << 4;
  u_wallace_cla4_u_cla6_b |= ((u_wallace_cla4_and_3_3 >> 0) & 0x01ull) << 5;
  u_wallace_cla4_u_cla6_out = u_cla6(u_wallace_cla4_u_cla6_a, u_wallace_cla4_u_cla6_b);

  u_wallace_cla4_out |= ((u_wallace_cla4_and_0_0 >> 0) & 0x01ull) << 0;
  u_wallace_cla4_out |= ((u_wallace_cla4_u_cla6_out >> 0) & 0x01ull) << 1;
  u_wallace_cla4_out |= ((u_wallace_cla4_u_cla6_out >> 1) & 0x01ull) << 2;
  u_wallace_cla4_out |= ((u_wallace_cla4_u_cla6_out >> 2) & 0x01ull) << 3;
  u_wallace_cla4_out |= ((u_wallace_cla4_u_cla6_out >> 3) & 0x01ull) << 4;
  u_wallace_cla4_out |= ((u_wallace_cla4_u_cla6_out >> 4) & 0x01ull) << 5;
  u_wallace_cla4_out |= ((u_wallace_cla4_u_cla6_out >> 5) & 0x01ull) << 6;
  u_wallace_cla4_out |= ((u_wallace_cla4_u_cla6_out >> 6) & 0x01ull) << 7;
  return u_wallace_cla4_out;
}