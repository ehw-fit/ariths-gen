...
uint64_t h_s_dadda_pg_rca4(uint64_t a, uint64_t b){
  ...
  uint64_t h_s_dadda_pg_rca4_u_pg_rca6_u_pg_rca6_a = 0;
  uint64_t h_s_dadda_pg_rca4_u_pg_rca6_u_pg_rca6_b = 0;
  uint64_t h_s_dadda_pg_rca4_u_pg_rca6_out = 0;
  uint8_t h_s_dadda_pg_rca4_u_pg_rca6_fa0_y2 = 0;
  uint8_t h_s_dadda_pg_rca4_u_pg_rca6_fa1_y2 = 0;
  uint8_t h_s_dadda_pg_rca4_u_pg_rca6_fa2_y2 = 0;
  uint8_t h_s_dadda_pg_rca4_u_pg_rca6_fa3_y2 = 0;
  uint8_t h_s_dadda_pg_rca4_u_pg_rca6_fa4_y2 = 0;
  uint8_t h_s_dadda_pg_rca4_u_pg_rca6_fa5_y2 = 0;
  uint8_t h_s_dadda_pg_rca4_u_pg_rca6_or5_y0 = 0;
  ...
  h_s_dadda_pg_rca4_nand_3_0_y0 = nand_gate(a_3, b_0);
  h_s_dadda_pg_rca4_and_2_1_y0 = and_gate(a_2, b_1);
  h_s_dadda_pg_rca4_ha0_y0 = (ha(h_s_dadda_pg_rca4_nand_3_0_y0, h_s_dadda_pg_rca4_and_2_1_y0) >> 0) & 0x01;
  h_s_dadda_pg_rca4_ha0_y1 = (ha(h_s_dadda_pg_rca4_nand_3_0_y0, h_s_dadda_pg_rca4_and_2_1_y0) >> 1) & 0x01;
  h_s_dadda_pg_rca4_nand_3_1_y0 = nand_gate(a_3, b_1);
  h_s_dadda_pg_rca4_fa0_y2 = (fa(h_s_dadda_pg_rca4_ha0_y1, constant_wire_1, h_s_dadda_pg_rca4_nand_3_1_y0) >> 0) & 0x01;
  h_s_dadda_pg_rca4_fa0_y4 = (fa(h_s_dadda_pg_rca4_ha0_y1, constant_wire_1, h_s_dadda_pg_rca4_nand_3_1_y0) >> 1) & 0x01;
  h_s_dadda_pg_rca4_and_2_0_y0 = and_gate(a_2, b_0);
  h_s_dadda_pg_rca4_and_1_1_y0 = and_gate(a_1, b_1);
  h_s_dadda_pg_rca4_ha1_y0 = (ha(h_s_dadda_pg_rca4_and_2_0_y0, h_s_dadda_pg_rca4_and_1_1_y0) >> 0) & 0x01;
  h_s_dadda_pg_rca4_ha1_y1 = (ha(h_s_dadda_pg_rca4_and_2_0_y0, h_s_dadda_pg_rca4_and_1_1_y0) >> 1) & 0x01;
  h_s_dadda_pg_rca4_and_1_2_y0 = and_gate(a_1, b_2);
  h_s_dadda_pg_rca4_nand_0_3_y0 = nand_gate(a_0, b_3);
  h_s_dadda_pg_rca4_fa1_y2 = (fa(h_s_dadda_pg_rca4_ha1_y1, h_s_dadda_pg_rca4_and_1_2_y0, h_s_dadda_pg_rca4_nand_0_3_y0) >> 0) & 0x01;
  h_s_dadda_pg_rca4_fa1_y4 = (fa(h_s_dadda_pg_rca4_ha1_y1, h_s_dadda_pg_rca4_and_1_2_y0, h_s_dadda_pg_rca4_nand_0_3_y0) >> 1) & 0x01;
  h_s_dadda_pg_rca4_and_2_2_y0 = and_gate(a_2, b_2);
  h_s_dadda_pg_rca4_nand_1_3_y0 = nand_gate(a_1, b_3);
  h_s_dadda_pg_rca4_fa2_y2 = (fa(h_s_dadda_pg_rca4_fa1_y4, h_s_dadda_pg_rca4_and_2_2_y0, h_s_dadda_pg_rca4_nand_1_3_y0) >> 0) & 0x01;
  h_s_dadda_pg_rca4_fa2_y4 = (fa(h_s_dadda_pg_rca4_fa1_y4, h_s_dadda_pg_rca4_and_2_2_y0, h_s_dadda_pg_rca4_nand_1_3_y0) >> 1) & 0x01;
  h_s_dadda_pg_rca4_nand_3_2_y0 = nand_gate(a_3, b_2);
  h_s_dadda_pg_rca4_fa3_y2 = (fa(h_s_dadda_pg_rca4_fa2_y4, h_s_dadda_pg_rca4_fa0_y4, h_s_dadda_pg_rca4_nand_3_2_y0) >> 0) & 0x01;
  h_s_dadda_pg_rca4_fa3_y4 = (fa(h_s_dadda_pg_rca4_fa2_y4, h_s_dadda_pg_rca4_fa0_y4, h_s_dadda_pg_rca4_nand_3_2_y0) >> 1) & 0x01;
  h_s_dadda_pg_rca4_and_0_0_y0 = and_gate(a_0, b_0);
  h_s_dadda_pg_rca4_and_1_0_y0 = and_gate(a_1, b_0);
  h_s_dadda_pg_rca4_and_0_2_y0 = and_gate(a_0, b_2);
  h_s_dadda_pg_rca4_nand_2_3_y0 = nand_gate(a_2, b_3);
  h_s_dadda_pg_rca4_and_0_1_y0 = and_gate(a_0, b_1);
  h_s_dadda_pg_rca4_and_3_3_y0 = and_gate(a_3, b_3);
  h_s_dadda_pg_rca4_u_pg_rca6_u_pg_rca6_a |= (h_s_dadda_pg_rca4_and_1_0_y0 & 0x01) << 0;
  h_s_dadda_pg_rca4_u_pg_rca6_u_pg_rca6_a |= (h_s_dadda_pg_rca4_and_0_2_y0 & 0x01) << 1;
  h_s_dadda_pg_rca4_u_pg_rca6_u_pg_rca6_a |= (h_s_dadda_pg_rca4_ha0_y0 & 0x01) << 2;
  h_s_dadda_pg_rca4_u_pg_rca6_u_pg_rca6_a |= (h_s_dadda_pg_rca4_fa0_y2 & 0x01) << 3;
  h_s_dadda_pg_rca4_u_pg_rca6_u_pg_rca6_a |= (h_s_dadda_pg_rca4_nand_2_3_y0 & 0x01) << 4;
  h_s_dadda_pg_rca4_u_pg_rca6_u_pg_rca6_a |= (h_s_dadda_pg_rca4_fa3_y4 & 0x01) << 5;
  h_s_dadda_pg_rca4_u_pg_rca6_u_pg_rca6_b |= (h_s_dadda_pg_rca4_and_0_1_y0 & 0x01) << 0;
  h_s_dadda_pg_rca4_u_pg_rca6_u_pg_rca6_b |= (h_s_dadda_pg_rca4_ha1_y0 & 0x01) << 1;
  h_s_dadda_pg_rca4_u_pg_rca6_u_pg_rca6_b |= (h_s_dadda_pg_rca4_fa1_y2 & 0x01) << 2;
  h_s_dadda_pg_rca4_u_pg_rca6_u_pg_rca6_b |= (h_s_dadda_pg_rca4_fa2_y2 & 0x01) << 3;
  h_s_dadda_pg_rca4_u_pg_rca6_u_pg_rca6_b |= (h_s_dadda_pg_rca4_fa3_y2 & 0x01) << 4;
  h_s_dadda_pg_rca4_u_pg_rca6_u_pg_rca6_b |= (h_s_dadda_pg_rca4_and_3_3_y0 & 0x01) << 5;
  h_s_dadda_pg_rca4_u_pg_rca6_out = u_pg_rca6(h_s_dadda_pg_rca4_u_pg_rca6_u_pg_rca6_a, h_s_dadda_pg_rca4_u_pg_rca6_u_pg_rca6_b);
  h_s_dadda_pg_rca4_u_pg_rca6_fa0_y2 = ((h_s_dadda_pg_rca4_u_pg_rca6_out >> 0) & 0x01);
  h_s_dadda_pg_rca4_u_pg_rca6_fa1_y2 = ((h_s_dadda_pg_rca4_u_pg_rca6_out >> 1) & 0x01);
  h_s_dadda_pg_rca4_u_pg_rca6_fa2_y2 = ((h_s_dadda_pg_rca4_u_pg_rca6_out >> 2) & 0x01);
  h_s_dadda_pg_rca4_u_pg_rca6_fa3_y2 = ((h_s_dadda_pg_rca4_u_pg_rca6_out >> 3) & 0x01);
  h_s_dadda_pg_rca4_u_pg_rca6_fa4_y2 = ((h_s_dadda_pg_rca4_u_pg_rca6_out >> 4) & 0x01);
  h_s_dadda_pg_rca4_u_pg_rca6_fa5_y2 = ((h_s_dadda_pg_rca4_u_pg_rca6_out >> 5) & 0x01);
  h_s_dadda_pg_rca4_u_pg_rca6_or5_y0 = ((h_s_dadda_pg_rca4_u_pg_rca6_out >> 6) & 0x01);
  h_s_dadda_pg_rca4_xor0_y0 = xor_gate(constant_wire_1, h_s_dadda_pg_rca4_u_pg_rca6_or5_y0);

  out |= (h_s_dadda_pg_rca4_and_0_0_y0 & 0x01) << 0;
  out |= (h_s_dadda_pg_rca4_u_pg_rca6_fa0_y2 & 0x01) << 1;
  out |= (h_s_dadda_pg_rca4_u_pg_rca6_fa1_y2 & 0x01) << 2;
  out |= (h_s_dadda_pg_rca4_u_pg_rca6_fa2_y2 & 0x01) << 3;
  out |= (h_s_dadda_pg_rca4_u_pg_rca6_fa3_y2 & 0x01) << 4;
  out |= (h_s_dadda_pg_rca4_u_pg_rca6_fa4_y2 & 0x01) << 5;
  out |= (h_s_dadda_pg_rca4_u_pg_rca6_fa5_y2 & 0x01) << 6;
