...
uint64_t h_u_csabam8_cla_h6_v8(uint64_t a, uint64_t b){
  uint64_t h_u_csabam8_cla_h6_v8_out = 0;
  uint8_t h_u_csabam8_cla_h6_v8_and2_6 = 0;
  uint8_t h_u_csabam8_cla_h6_v8_and3_6 = 0;
  uint8_t h_u_csabam8_cla_h6_v8_and4_6 = 0;
  uint8_t h_u_csabam8_cla_h6_v8_and5_6 = 0;
  uint8_t h_u_csabam8_cla_h6_v8_and6_6 = 0;
  uint8_t h_u_csabam8_cla_h6_v8_and7_6 = 0;
  uint8_t h_u_csabam8_cla_h6_v8_and1_7 = 0;
  uint8_t h_u_csabam8_cla_h6_v8_ha1_7_xor0 = 0;
  uint8_t h_u_csabam8_cla_h6_v8_ha1_7_and0 = 0;
  uint8_t h_u_csabam8_cla_h6_v8_and2_7 = 0;
  uint8_t h_u_csabam8_cla_h6_v8_ha2_7_xor0 = 0;
  uint8_t h_u_csabam8_cla_h6_v8_ha2_7_and0 = 0;
  uint8_t h_u_csabam8_cla_h6_v8_and3_7 = 0;
  uint8_t h_u_csabam8_cla_h6_v8_ha3_7_xor0 = 0;
  uint8_t h_u_csabam8_cla_h6_v8_ha3_7_and0 = 0;
  uint8_t h_u_csabam8_cla_h6_v8_and4_7 = 0;
  uint8_t h_u_csabam8_cla_h6_v8_ha4_7_xor0 = 0;
  uint8_t h_u_csabam8_cla_h6_v8_ha4_7_and0 = 0;
  uint8_t h_u_csabam8_cla_h6_v8_and5_7 = 0;
  uint8_t h_u_csabam8_cla_h6_v8_ha5_7_xor0 = 0;
  uint8_t h_u_csabam8_cla_h6_v8_ha5_7_and0 = 0;
  uint8_t h_u_csabam8_cla_h6_v8_and6_7 = 0;
  uint8_t h_u_csabam8_cla_h6_v8_ha6_7_xor0 = 0;
  uint8_t h_u_csabam8_cla_h6_v8_ha6_7_and0 = 0;
  uint8_t h_u_csabam8_cla_h6_v8_and7_7 = 0;
  uint64_t h_u_csabam8_cla_h6_v8_u_cla7_a = 0;
  uint64_t h_u_csabam8_cla_h6_v8_u_cla7_b = 0;
  uint64_t h_u_csabam8_cla_h6_v8_u_cla7_out = 0;

  h_u_csabam8_cla_h6_v8_and2_6 = and_gate(((a >> 2) & 0x01), ((b >> 6) & 0x01));
  h_u_csabam8_cla_h6_v8_and3_6 = and_gate(((a >> 3) & 0x01), ((b >> 6) & 0x01));
  h_u_csabam8_cla_h6_v8_and4_6 = and_gate(((a >> 4) & 0x01), ((b >> 6) & 0x01));
  h_u_csabam8_cla_h6_v8_and5_6 = and_gate(((a >> 5) & 0x01), ((b >> 6) & 0x01));
  h_u_csabam8_cla_h6_v8_and6_6 = and_gate(((a >> 6) & 0x01), ((b >> 6) & 0x01));
  h_u_csabam8_cla_h6_v8_and7_6 = and_gate(((a >> 7) & 0x01), ((b >> 6) & 0x01));
  h_u_csabam8_cla_h6_v8_and1_7 = and_gate(((a >> 1) & 0x01), ((b >> 7) & 0x01));
  h_u_csabam8_cla_h6_v8_ha1_7_xor0 = (ha(((h_u_csabam8_cla_h6_v8_and1_7 >> 0) & 0x01), ((h_u_csabam8_cla_h6_v8_and2_6 >> 0) & 0x01)) >> 0) & 0x01;
  h_u_csabam8_cla_h6_v8_ha1_7_and0 = (ha(((h_u_csabam8_cla_h6_v8_and1_7 >> 0) & 0x01), ((h_u_csabam8_cla_h6_v8_and2_6 >> 0) & 0x01)) >> 1) & 0x01;
  h_u_csabam8_cla_h6_v8_and2_7 = and_gate(((a >> 2) & 0x01), ((b >> 7) & 0x01));
  h_u_csabam8_cla_h6_v8_ha2_7_xor0 = (ha(((h_u_csabam8_cla_h6_v8_and2_7 >> 0) & 0x01), ((h_u_csabam8_cla_h6_v8_and3_6 >> 0) & 0x01)) >> 0) & 0x01;
  h_u_csabam8_cla_h6_v8_ha2_7_and0 = (ha(((h_u_csabam8_cla_h6_v8_and2_7 >> 0) & 0x01), ((h_u_csabam8_cla_h6_v8_and3_6 >> 0) & 0x01)) >> 1) & 0x01;
  h_u_csabam8_cla_h6_v8_and3_7 = and_gate(((a >> 3) & 0x01), ((b >> 7) & 0x01));
  h_u_csabam8_cla_h6_v8_ha3_7_xor0 = (ha(((h_u_csabam8_cla_h6_v8_and3_7 >> 0) & 0x01), ((h_u_csabam8_cla_h6_v8_and4_6 >> 0) & 0x01)) >> 0) & 0x01;
  h_u_csabam8_cla_h6_v8_ha3_7_and0 = (ha(((h_u_csabam8_cla_h6_v8_and3_7 >> 0) & 0x01), ((h_u_csabam8_cla_h6_v8_and4_6 >> 0) & 0x01)) >> 1) & 0x01;
  h_u_csabam8_cla_h6_v8_and4_7 = and_gate(((a >> 4) & 0x01), ((b >> 7) & 0x01));
  h_u_csabam8_cla_h6_v8_ha4_7_xor0 = (ha(((h_u_csabam8_cla_h6_v8_and4_7 >> 0) & 0x01), ((h_u_csabam8_cla_h6_v8_and5_6 >> 0) & 0x01)) >> 0) & 0x01;
  h_u_csabam8_cla_h6_v8_ha4_7_and0 = (ha(((h_u_csabam8_cla_h6_v8_and4_7 >> 0) & 0x01), ((h_u_csabam8_cla_h6_v8_and5_6 >> 0) & 0x01)) >> 1) & 0x01;
  h_u_csabam8_cla_h6_v8_and5_7 = and_gate(((a >> 5) & 0x01), ((b >> 7) & 0x01));
  h_u_csabam8_cla_h6_v8_ha5_7_xor0 = (ha(((h_u_csabam8_cla_h6_v8_and5_7 >> 0) & 0x01), ((h_u_csabam8_cla_h6_v8_and6_6 >> 0) & 0x01)) >> 0) & 0x01;
  h_u_csabam8_cla_h6_v8_ha5_7_and0 = (ha(((h_u_csabam8_cla_h6_v8_and5_7 >> 0) & 0x01), ((h_u_csabam8_cla_h6_v8_and6_6 >> 0) & 0x01)) >> 1) & 0x01;
  h_u_csabam8_cla_h6_v8_and6_7 = and_gate(((a >> 6) & 0x01), ((b >> 7) & 0x01));
  h_u_csabam8_cla_h6_v8_ha6_7_xor0 = (ha(((h_u_csabam8_cla_h6_v8_and6_7 >> 0) & 0x01), ((h_u_csabam8_cla_h6_v8_and7_6 >> 0) & 0x01)) >> 0) & 0x01;
  h_u_csabam8_cla_h6_v8_ha6_7_and0 = (ha(((h_u_csabam8_cla_h6_v8_and6_7 >> 0) & 0x01), ((h_u_csabam8_cla_h6_v8_and7_6 >> 0) & 0x01)) >> 1) & 0x01;
  h_u_csabam8_cla_h6_v8_and7_7 = and_gate(((a >> 7) & 0x01), ((b >> 7) & 0x01));
  h_u_csabam8_cla_h6_v8_u_cla7_a |= ((h_u_csabam8_cla_h6_v8_ha2_7_xor0 >> 0) & 0x01ull) << 0;
  h_u_csabam8_cla_h6_v8_u_cla7_a |= ((h_u_csabam8_cla_h6_v8_ha3_7_xor0 >> 0) & 0x01ull) << 1;
  h_u_csabam8_cla_h6_v8_u_cla7_a |= ((h_u_csabam8_cla_h6_v8_ha4_7_xor0 >> 0) & 0x01ull) << 2;
  h_u_csabam8_cla_h6_v8_u_cla7_a |= ((h_u_csabam8_cla_h6_v8_ha5_7_xor0 >> 0) & 0x01ull) << 3;
  h_u_csabam8_cla_h6_v8_u_cla7_a |= ((h_u_csabam8_cla_h6_v8_ha6_7_xor0 >> 0) & 0x01ull) << 4;
  h_u_csabam8_cla_h6_v8_u_cla7_a |= ((h_u_csabam8_cla_h6_v8_and7_7 >> 0) & 0x01ull) << 5;
  h_u_csabam8_cla_h6_v8_u_cla7_a |= (0x00) << 6;
  h_u_csabam8_cla_h6_v8_u_cla7_b |= (0x00) << 0;
  h_u_csabam8_cla_h6_v8_u_cla7_b |= ((h_u_csabam8_cla_h6_v8_ha2_7_and0 >> 0) & 0x01ull) << 1;
  h_u_csabam8_cla_h6_v8_u_cla7_b |= ((h_u_csabam8_cla_h6_v8_ha3_7_and0 >> 0) & 0x01ull) << 2;
  h_u_csabam8_cla_h6_v8_u_cla7_b |= ((h_u_csabam8_cla_h6_v8_ha4_7_and0 >> 0) & 0x01ull) << 3;
  h_u_csabam8_cla_h6_v8_u_cla7_b |= ((h_u_csabam8_cla_h6_v8_ha5_7_and0 >> 0) & 0x01ull) << 4;
  h_u_csabam8_cla_h6_v8_u_cla7_b |= ((h_u_csabam8_cla_h6_v8_ha6_7_and0 >> 0) & 0x01ull) << 5;
  h_u_csabam8_cla_h6_v8_u_cla7_b |= (0x00) << 6;
  h_u_csabam8_cla_h6_v8_u_cla7_out = u_cla7(h_u_csabam8_cla_h6_v8_u_cla7_a, h_u_csabam8_cla_h6_v8_u_cla7_b);

  h_u_csabam8_cla_h6_v8_out |= (0x00) << 0;
  h_u_csabam8_cla_h6_v8_out |= (0x00) << 1;
  h_u_csabam8_cla_h6_v8_out |= (0x00) << 2;
  h_u_csabam8_cla_h6_v8_out |= (0x00) << 3;
  h_u_csabam8_cla_h6_v8_out |= (0x00) << 4;
  h_u_csabam8_cla_h6_v8_out |= (0x00) << 5;
  h_u_csabam8_cla_h6_v8_out |= (0x00) << 6;
  h_u_csabam8_cla_h6_v8_out |= (0x00) << 7;
  h_u_csabam8_cla_h6_v8_out |= ((h_u_csabam8_cla_h6_v8_u_cla7_out >> 0) & 0x01ull) << 8;
  h_u_csabam8_cla_h6_v8_out |= ((h_u_csabam8_cla_h6_v8_u_cla7_out >> 1) & 0x01ull) << 9;
  h_u_csabam8_cla_h6_v8_out |= ((h_u_csabam8_cla_h6_v8_u_cla7_out >> 2) & 0x01ull) << 10;
  h_u_csabam8_cla_h6_v8_out |= ((h_u_csabam8_cla_h6_v8_u_cla7_out >> 3) & 0x01ull) << 11;
  h_u_csabam8_cla_h6_v8_out |= ((h_u_csabam8_cla_h6_v8_u_cla7_out >> 4) & 0x01ull) << 12;
  h_u_csabam8_cla_h6_v8_out |= ((h_u_csabam8_cla_h6_v8_u_cla7_out >> 5) & 0x01ull) << 13;
  h_u_csabam8_cla_h6_v8_out |= ((h_u_csabam8_cla_h6_v8_u_cla7_out >> 6) & 0x01ull) << 14;
  h_u_csabam8_cla_h6_v8_out |= (0x00) << 15;
  return h_u_csabam8_cla_h6_v8_out;
}