...
class FourInputOneBitCircuit(TwoInputOneBitCircuit, GeneralCircuit):
    ...
    """ C CODE GENERATION """
    # FLAT C #
    # Function prototype with four inputs
    ...
    # FLAT VERILOG #
    # Module prototype with four inputs
    ...
    # FLAT BLIF #
    # Model prototype with four inputs
    ...
    # HIERARCHICAL BLIF #
    # Subcomponent generation (4 inputs)
    ...
    """ CGP CODE GENERATION """
    # FLAT CGP #
    # Chromosome prototype with four inputs
