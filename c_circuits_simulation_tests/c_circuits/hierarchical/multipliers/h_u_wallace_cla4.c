...
uint64_t h_u_wallace_cla4(uint64_t a, uint64_t b){
  uint8_t h_u_wallace_cla4_out = 0;
  uint8_t h_u_wallace_cla4_and_2_0 = 0;
  uint8_t h_u_wallace_cla4_and_1_1 = 0;
  uint8_t h_u_wallace_cla4_ha0_xor0 = 0;
  uint8_t h_u_wallace_cla4_ha0_and0 = 0;
  uint8_t h_u_wallace_cla4_and_3_0 = 0;
  uint8_t h_u_wallace_cla4_and_2_1 = 0;
  uint8_t h_u_wallace_cla4_fa0_xor1 = 0;
  uint8_t h_u_wallace_cla4_fa0_or0 = 0;
  uint8_t h_u_wallace_cla4_and_3_1 = 0;
  uint8_t h_u_wallace_cla4_and_2_2 = 0;
  uint8_t h_u_wallace_cla4_fa1_xor1 = 0;
  uint8_t h_u_wallace_cla4_fa1_or0 = 0;
  uint8_t h_u_wallace_cla4_and_1_2 = 0;
  uint8_t h_u_wallace_cla4_and_0_3 = 0;
  uint8_t h_u_wallace_cla4_ha1_xor0 = 0;
  uint8_t h_u_wallace_cla4_ha1_and0 = 0;
  uint8_t h_u_wallace_cla4_and_1_3 = 0;
  uint8_t h_u_wallace_cla4_ha2_xor0 = 0;
  uint8_t h_u_wallace_cla4_ha2_and0 = 0;
  uint8_t h_u_wallace_cla4_and_3_2 = 0;
  uint8_t h_u_wallace_cla4_fa2_xor1 = 0;
  uint8_t h_u_wallace_cla4_fa2_or0 = 0;
  uint8_t h_u_wallace_cla4_and_0_0 = 0;
  uint8_t h_u_wallace_cla4_and_1_0 = 0;
  uint8_t h_u_wallace_cla4_and_0_2 = 0;
  uint8_t h_u_wallace_cla4_and_2_3 = 0;
  uint8_t h_u_wallace_cla4_and_0_1 = 0;
  uint8_t h_u_wallace_cla4_and_3_3 = 0;
  uint64_t h_u_wallace_cla4_u_cla6_a = 0;
  uint64_t h_u_wallace_cla4_u_cla6_b = 0;
  uint64_t h_u_wallace_cla4_u_cla6_out = 0;

  h_u_wallace_cla4_and_2_0 = and_gate(((a >> 2) & 0x01), ((b >> 0) & 0x01));
  h_u_wallace_cla4_and_1_1 = and_gate(((a >> 1) & 0x01), ((b >> 1) & 0x01));
  h_u_wallace_cla4_ha0_xor0 = (ha(((h_u_wallace_cla4_and_2_0 >> 0) & 0x01), ((h_u_wallace_cla4_and_1_1 >> 0) & 0x01)) >> 0) & 0x01;
  h_u_wallace_cla4_ha0_and0 = (ha(((h_u_wallace_cla4_and_2_0 >> 0) & 0x01), ((h_u_wallace_cla4_and_1_1 >> 0) & 0x01)) >> 1) & 0x01;
  h_u_wallace_cla4_and_3_0 = and_gate(((a >> 3) & 0x01), ((b >> 0) & 0x01));
  h_u_wallace_cla4_and_2_1 = and_gate(((a >> 2) & 0x01), ((b >> 1) & 0x01));
  h_u_wallace_cla4_fa0_xor1 = (fa(((h_u_wallace_cla4_ha0_and0 >> 0) & 0x01), ((h_u_wallace_cla4_and_3_0 >> 0) & 0x01), ((h_u_wallace_cla4_and_2_1 >> 0) & 0x01)) >> 0) & 0x01;
  h_u_wallace_cla4_fa0_or0 = (fa(((h_u_wallace_cla4_ha0_and0 >> 0) & 0x01), ((h_u_wallace_cla4_and_3_0 >> 0) & 0x01), ((h_u_wallace_cla4_and_2_1 >> 0) & 0x01)) >> 1) & 0x01;
  h_u_wallace_cla4_and_3_1 = and_gate(((a >> 3) & 0x01), ((b >> 1) & 0x01));
  h_u_wallace_cla4_and_2_2 = and_gate(((a >> 2) & 0x01), ((b >> 2) & 0x01));
  h_u_wallace_cla4_fa1_xor1 = (fa(((h_u_wallace_cla4_fa0_or0 >> 0) & 0x01), ((h_u_wallace_cla4_and_3_1 >> 0) & 0x01), ((h_u_wallace_cla4_and_2_2 >> 0) & 0x01)) >> 0) & 0x01;
  h_u_wallace_cla4_fa1_or0 = (fa(((h_u_wallace_cla4_fa0_or0 >> 0) & 0x01), ((h_u_wallace_cla4_and_3_1 >> 0) & 0x01), ((h_u_wallace_cla4_and_2_2 >> 0) & 0x01)) >> 1) & 0x01;
  h_u_wallace_cla4_and_1_2 = and_gate(((a >> 1) & 0x01), ((b >> 2) & 0x01));
  h_u_wallace_cla4_and_0_3 = and_gate(((a >> 0) & 0x01), ((b >> 3) & 0x01));
  h_u_wallace_cla4_ha1_xor0 = (ha(((h_u_wallace_cla4_and_1_2 >> 0) & 0x01), ((h_u_wallace_cla4_and_0_3 >> 0) & 0x01)) >> 0) & 0x01;
  h_u_wallace_cla4_ha1_and0 = (ha(((h_u_wallace_cla4_and_1_2 >> 0) & 0x01), ((h_u_wallace_cla4_and_0_3 >> 0) & 0x01)) >> 1) & 0x01;
  h_u_wallace_cla4_and_1_3 = and_gate(((a >> 1) & 0x01), ((b >> 3) & 0x01));
  h_u_wallace_cla4_ha2_xor0 = (ha(((h_u_wallace_cla4_ha1_and0 >> 0) & 0x01), ((h_u_wallace_cla4_and_1_3 >> 0) & 0x01)) >> 0) & 0x01;
  h_u_wallace_cla4_ha2_and0 = (ha(((h_u_wallace_cla4_ha1_and0 >> 0) & 0x01), ((h_u_wallace_cla4_and_1_3 >> 0) & 0x01)) >> 1) & 0x01;
  h_u_wallace_cla4_and_3_2 = and_gate(((a >> 3) & 0x01), ((b >> 2) & 0x01));
  h_u_wallace_cla4_fa2_xor1 = (fa(((h_u_wallace_cla4_ha2_and0 >> 0) & 0x01), ((h_u_wallace_cla4_fa1_or0 >> 0) & 0x01), ((h_u_wallace_cla4_and_3_2 >> 0) & 0x01)) >> 0) & 0x01;
  h_u_wallace_cla4_fa2_or0 = (fa(((h_u_wallace_cla4_ha2_and0 >> 0) & 0x01), ((h_u_wallace_cla4_fa1_or0 >> 0) & 0x01), ((h_u_wallace_cla4_and_3_2 >> 0) & 0x01)) >> 1) & 0x01;
  h_u_wallace_cla4_and_0_0 = and_gate(((a >> 0) & 0x01), ((b >> 0) & 0x01));
  h_u_wallace_cla4_and_1_0 = and_gate(((a >> 1) & 0x01), ((b >> 0) & 0x01));
  h_u_wallace_cla4_and_0_2 = and_gate(((a >> 0) & 0x01), ((b >> 2) & 0x01));
  h_u_wallace_cla4_and_2_3 = and_gate(((a >> 2) & 0x01), ((b >> 3) & 0x01));
  h_u_wallace_cla4_and_0_1 = and_gate(((a >> 0) & 0x01), ((b >> 1) & 0x01));
  h_u_wallace_cla4_and_3_3 = and_gate(((a >> 3) & 0x01), ((b >> 3) & 0x01));
  h_u_wallace_cla4_u_cla6_a |= ((h_u_wallace_cla4_and_1_0 >> 0) & 0x01) << 0;
  h_u_wallace_cla4_u_cla6_a |= ((h_u_wallace_cla4_and_0_2 >> 0) & 0x01) << 1;
  h_u_wallace_cla4_u_cla6_a |= ((h_u_wallace_cla4_fa0_xor1 >> 0) & 0x01) << 2;
  h_u_wallace_cla4_u_cla6_a |= ((h_u_wallace_cla4_fa1_xor1 >> 0) & 0x01) << 3;
  h_u_wallace_cla4_u_cla6_a |= ((h_u_wallace_cla4_and_2_3 >> 0) & 0x01) << 4;
  h_u_wallace_cla4_u_cla6_a |= ((h_u_wallace_cla4_fa2_or0 >> 0) & 0x01) << 5;
  h_u_wallace_cla4_u_cla6_b |= ((h_u_wallace_cla4_and_0_1 >> 0) & 0x01) << 0;
  h_u_wallace_cla4_u_cla6_b |= ((h_u_wallace_cla4_ha0_xor0 >> 0) & 0x01) << 1;
  h_u_wallace_cla4_u_cla6_b |= ((h_u_wallace_cla4_ha1_xor0 >> 0) & 0x01) << 2;
  h_u_wallace_cla4_u_cla6_b |= ((h_u_wallace_cla4_ha2_xor0 >> 0) & 0x01) << 3;
  h_u_wallace_cla4_u_cla6_b |= ((h_u_wallace_cla4_fa2_xor1 >> 0) & 0x01) << 4;
  h_u_wallace_cla4_u_cla6_b |= ((h_u_wallace_cla4_and_3_3 >> 0) & 0x01) << 5;
  h_u_wallace_cla4_u_cla6_out = u_cla6(h_u_wallace_cla4_u_cla6_a, h_u_wallace_cla4_u_cla6_b);

  h_u_wallace_cla4_out |= ((h_u_wallace_cla4_and_0_0 >> 0) & 0x01) << 0;
  h_u_wallace_cla4_out |= ((h_u_wallace_cla4_u_cla6_out >> 0) & 0x01) << 1;
  h_u_wallace_cla4_out |= ((h_u_wallace_cla4_u_cla6_out >> 1) & 0x01) << 2;
  h_u_wallace_cla4_out |= ((h_u_wallace_cla4_u_cla6_out >> 2) & 0x01) << 3;
  h_u_wallace_cla4_out |= ((h_u_wallace_cla4_u_cla6_out >> 3) & 0x01) << 4;
  h_u_wallace_cla4_out |= ((h_u_wallace_cla4_u_cla6_out >> 4) & 0x01) << 5;
  h_u_wallace_cla4_out |= ((h_u_wallace_cla4_u_cla6_out >> 5) & 0x01) << 6;
  h_u_wallace_cla4_out |= ((h_u_wallace_cla4_u_cla6_out >> 6) & 0x01) << 7;
  return h_u_wallace_cla4_out;
}
...
int main(){
  for (int i = 0; i < 16; i++){
    for (int j = 0; j < 16; j++){
      assert((i * j) == h_u_wallace_cla4(i,j));
    }
  }
  return 0;
}