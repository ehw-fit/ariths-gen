...
uint64_t h_u_dadda_rca4(uint64_t a, uint64_t b){
  ...
  uint64_t h_u_dadda_rca4_u_rca6_u_rca6_a = 0;
  uint64_t h_u_dadda_rca4_u_rca6_u_rca6_b = 0;
  uint64_t h_u_dadda_rca4_u_rca6_out = 0;
  uint8_t h_u_dadda_rca4_u_rca6_ha_y0 = 0;
  uint8_t h_u_dadda_rca4_u_rca6_fa1_y2 = 0;
  uint8_t h_u_dadda_rca4_u_rca6_fa2_y2 = 0;
  uint8_t h_u_dadda_rca4_u_rca6_fa3_y2 = 0;
  uint8_t h_u_dadda_rca4_u_rca6_fa4_y2 = 0;
  uint8_t h_u_dadda_rca4_u_rca6_fa5_y2 = 0;
  uint8_t h_u_dadda_rca4_u_rca6_fa5_y4 = 0;
  ...
  h_u_dadda_rca4_u_rca6_u_rca6_a |= (h_u_dadda_rca4_and_1_0_y0 & 0x01) << 0;
  h_u_dadda_rca4_u_rca6_u_rca6_a |= (h_u_dadda_rca4_and_0_2_y0 & 0x01) << 1;
  h_u_dadda_rca4_u_rca6_u_rca6_a |= (h_u_dadda_rca4_ha0_y0 & 0x01) << 2;
  h_u_dadda_rca4_u_rca6_u_rca6_a |= (h_u_dadda_rca4_ha1_y0 & 0x01) << 3;
  h_u_dadda_rca4_u_rca6_u_rca6_a |= (h_u_dadda_rca4_and_2_3_y0 & 0x01) << 4;
  h_u_dadda_rca4_u_rca6_u_rca6_a |= (h_u_dadda_rca4_fa2_y4 & 0x01) << 5;
  h_u_dadda_rca4_u_rca6_u_rca6_b |= (h_u_dadda_rca4_and_0_1_y0 & 0x01) << 0;
  h_u_dadda_rca4_u_rca6_u_rca6_b |= (h_u_dadda_rca4_ha2_y0 & 0x01) << 1;
  h_u_dadda_rca4_u_rca6_u_rca6_b |= (h_u_dadda_rca4_fa0_y2 & 0x01) << 2;
  h_u_dadda_rca4_u_rca6_u_rca6_b |= (h_u_dadda_rca4_fa1_y2 & 0x01) << 3;
  h_u_dadda_rca4_u_rca6_u_rca6_b |= (h_u_dadda_rca4_fa2_y2 & 0x01) << 4;
  h_u_dadda_rca4_u_rca6_u_rca6_b |= (h_u_dadda_rca4_and_3_3_y0 & 0x01) << 5;
  h_u_dadda_rca4_u_rca6_out = u_rca6(h_u_dadda_rca4_u_rca6_u_rca6_a, h_u_dadda_rca4_u_rca6_u_rca6_b);
  h_u_dadda_rca4_u_rca6_ha_y0 = ((h_u_dadda_rca4_u_rca6_out >> 0) & 0x01);
  h_u_dadda_rca4_u_rca6_fa1_y2 = ((h_u_dadda_rca4_u_rca6_out >> 1) & 0x01);
  h_u_dadda_rca4_u_rca6_fa2_y2 = ((h_u_dadda_rca4_u_rca6_out >> 2) & 0x01);
  h_u_dadda_rca4_u_rca6_fa3_y2 = ((h_u_dadda_rca4_u_rca6_out >> 3) & 0x01);
  h_u_dadda_rca4_u_rca6_fa4_y2 = ((h_u_dadda_rca4_u_rca6_out >> 4) & 0x01);
  h_u_dadda_rca4_u_rca6_fa5_y2 = ((h_u_dadda_rca4_u_rca6_out >> 5) & 0x01);
  h_u_dadda_rca4_u_rca6_fa5_y4 = ((h_u_dadda_rca4_u_rca6_out >> 6) & 0x01);

  out |= (h_u_dadda_rca4_and_0_0_y0 & 0x01) << 0;
  out |= (h_u_dadda_rca4_u_rca6_ha_y0 & 0x01) << 1;
  out |= (h_u_dadda_rca4_u_rca6_fa1_y2 & 0x01) << 2;
  out |= (h_u_dadda_rca4_u_rca6_fa2_y2 & 0x01) << 3;
  out |= (h_u_dadda_rca4_u_rca6_fa3_y2 & 0x01) << 4;
  out |= (h_u_dadda_rca4_u_rca6_fa4_y2 & 0x01) << 5;
  out |= (h_u_dadda_rca4_u_rca6_fa5_y2 & 0x01) << 6;
  out |= (h_u_dadda_rca4_u_rca6_fa5_y4 & 0x01) << 7;
  return out;
}
