...
F_U_CSA4="./f_u_csa4 2>/dev/null"
F_U_CSA8="./f_u_csa8 2>/dev/null"
...
H_U_CSA4="./h_u_csa4 2>/dev/null"
H_U_CSA8="./h_u_csa8 2>/dev/null"
...
F_S_CSA4="./f_s_csa4 2>/dev/null"
F_S_CSA8="./f_s_csa8 2>/dev/null"
...
H_S_CSA4="./h_s_csa4 2>/dev/null"
H_S_CSA8="./h_s_csa8 2>/dev/null"
...
F_U_DADDA_CSA4="./f_u_dadda_csa4 2>/dev/null"
F_U_DADDA_CSA8="./f_u_dadda_csa8 2>/dev/null"
...
F_U_WALLACE_CSA4="./f_u_wallace_csa4 2>/dev/null"
F_U_WALLACE_CSA8="./f_u_wallace_csa8 2>/dev/null"
...
H_U_DADDA_CSA4="./h_u_dadda_csa4 2>/dev/null"
H_U_DADDA_CSA8="./h_u_dadda_csa8 2>/dev/null"
...
H_U_WALLACE_CSA4="./h_u_wallace_csa4 2>/dev/null"
H_U_WALLACE_CSA8="./h_u_wallace_csa8 2>/dev/null"
...
F_S_DADDA_CSA4="./f_s_dadda_csa4 2>/dev/null"
F_S_DADDA_CSA8="./f_s_dadda_csa8 2>/dev/null"
...
F_S_WALLACE_CSA4="./f_s_wallace_csa4 2>/dev/null"
F_S_WALLACE_CSA8="./f_s_wallace_csa8 2>/dev/null"
...
H_S_DADDA_CSA4="./h_s_dadda_csa4 2>/dev/null"
H_S_DADDA_CSA8="./h_s_dadda_csa8 2>/dev/null"
...
H_S_WALLACE_CSA4="./h_s_wallace_csa4 2>/dev/null"
H_S_WALLACE_CSA8="./h_s_wallace_csa8 2>/dev/null"
...
${C} ${CFLAGS} ${FLAT_ADD_PATH}f_u_csa4.c -o f_u_csa4
TEST_NUM=$((TEST_NUM+1))
echo "TEST_$TEST_NUM: f_u_csa4.c"
eval "$F_U_CSA4"
if [ "$?" -eq 0 ] ; then
    echo "${GREENCOLOR}PASSED${NOCOLOR}"
else
...
${C} ${CFLAGS} ${FLAT_ADD_PATH}f_u_csa8.c -o f_u_csa8
TEST_NUM=$((TEST_NUM+1))
echo "TEST_$TEST_NUM: f_u_csa8.c"
eval "$F_U_CSA8"
if [ "$?" -eq 0 ] ; then
    echo "${GREENCOLOR}PASSED${NOCOLOR}"
else
...
${C} ${CFLAGS} ${FLAT_ADD_PATH}f_s_csa4.c -o f_s_csa4
TEST_NUM=$((TEST_NUM+1))
echo "TEST_$TEST_NUM: f_s_csa4.c"
eval "$F_S_CSA4"
if [ "$?" -eq 0 ] ; then
    echo "${GREENCOLOR}PASSED${NOCOLOR}"
else
...
${C} ${CFLAGS} ${FLAT_ADD_PATH}f_s_csa8.c -o f_s_csa8
TEST_NUM=$((TEST_NUM+1))
echo "TEST_$TEST_NUM: f_s_csa8.c"
eval "$F_S_CSA8"
if [ "$?" -eq 0 ] ; then
    echo "${GREENCOLOR}PASSED${NOCOLOR}"
else
...
# 4-BIT DADDA-CSA MULTIPLIER
${C} ${CFLAGS} ${FLAT_MUL_PATH}f_u_dadda_csa4.c -o f_u_dadda_csa4
TEST_NUM=$((TEST_NUM+1))
echo "TEST_$TEST_NUM: f_u_dadda_csa4.c"
eval "$F_U_DADDA_CSA4"
if [ "$?" -eq 0 ] ; then
    echo "${GREENCOLOR}PASSED${NOCOLOR}"
else
...
# 8-BIT DADDA-CSA MULTIPLIER
${C} ${CFLAGS} ${FLAT_MUL_PATH}f_u_dadda_csa8.c -o f_u_dadda_csa8
TEST_NUM=$((TEST_NUM+1))
echo "TEST_$TEST_NUM: f_u_dadda_csa8.c"
eval "$F_U_DADDA_CSA8"
if [ "$?" -eq 0 ] ; then
    echo "${GREENCOLOR}PASSED${NOCOLOR}"
else
...
# 4-BIT WALLACE-CSA MULTIPLIER
${C} ${CFLAGS} ${FLAT_MUL_PATH}f_u_wallace_csa4.c -o f_u_wallace_csa4
TEST_NUM=$((TEST_NUM+1))
echo "TEST_$TEST_NUM: f_u_wallace_csa4.c"
eval "$F_U_WALLACE_CSA4"
if [ "$?" -eq 0 ] ; then
    echo "${GREENCOLOR}PASSED${NOCOLOR}"
else
    echo "${REDCOLOR}FAILED${NOCOLOR}"
...
# 8-BIT WALLACE-CSA MULTIPLIER
${C} ${CFLAGS} ${FLAT_MUL_PATH}f_u_wallace_csa8.c -o f_u_wallace_csa8
TEST_NUM=$((TEST_NUM+1))
echo "TEST_$TEST_NUM: f_u_wallace_csa8.c"
eval "$F_U_WALLACE_CSA8"
if [ "$?" -eq 0 ] ; then
    echo "${GREENCOLOR}PASSED${NOCOLOR}"
else
    echo "${REDCOLOR}FAILED${NOCOLOR}"
...
# 4-BIT DADDA-CSA MULTIPLIER
${C} ${CFLAGS} ${FLAT_MUL_PATH}f_s_dadda_csa4.c -o f_s_dadda_csa4
TEST_NUM=$((TEST_NUM+1))
echo "TEST_$TEST_NUM: f_s_dadda_csa4.c"
eval "$F_S_DADDA_CSA4"
if [ "$?" -eq 0 ] ; then
    echo "${GREENCOLOR}PASSED${NOCOLOR}"
else
...
# 8-BIT DADDA-CSA MULTIPLIER
${C} ${CFLAGS} ${FLAT_MUL_PATH}f_s_dadda_csa8.c -o f_s_dadda_csa8
TEST_NUM=$((TEST_NUM+1))
echo "TEST_$TEST_NUM: f_s_dadda_csa8.c"
eval "$F_S_DADDA_CSA8"
if [ "$?" -eq 0 ] ; then
    echo "${GREENCOLOR}PASSED${NOCOLOR}"
else
...
# 4-BIT WALLACE-CSA MULTIPLIER
${C} ${CFLAGS} ${FLAT_MUL_PATH}f_s_wallace_csa4.c -o f_s_wallace_csa4
TEST_NUM=$((TEST_NUM+1))
echo "TEST_$TEST_NUM: f_s_wallace_csa4.c"
eval "$F_S_WALLACE_CSA4"
if [ "$?" -eq 0 ] ; then
    echo "${GREENCOLOR}PASSED${NOCOLOR}"
else
    echo "${REDCOLOR}FAILED${NOCOLOR}"
...
# 8-BIT WALLACE-CSA MULTIPLIER
${C} ${CFLAGS} ${FLAT_MUL_PATH}f_s_wallace_csa8.c -o f_s_wallace_csa8
TEST_NUM=$((TEST_NUM+1))
echo "TEST_$TEST_NUM: f_s_wallace_csa8.c"
eval "$F_S_WALLACE_CSA8"
if [ "$?" -eq 0 ] ; then
    echo "${GREENCOLOR}PASSED${NOCOLOR}"
else
    echo "${REDCOLOR}FAILED${NOCOLOR}"
...
# 4-BIT CARRY SAVE ADDER
${C} ${CFLAGS} ${HIER_ADD_PATH}h_u_csa4.c -o h_u_csa4
TEST_NUM=$((TEST_NUM+1))
echo "TEST_$TEST_NUM: h_u_csa4.c"
eval "$H_U_CSA4"
if [ "$?" -eq 0 ] ; then
    echo "${GREENCOLOR}PASSED${NOCOLOR}"
else
...
# 8-BIT CARRY SAVE ADDER
${C} ${CFLAGS} ${HIER_ADD_PATH}h_u_csa8.c -o h_u_csa8
TEST_NUM=$((TEST_NUM+1))
echo "TEST_$TEST_NUM: h_u_csa8.c"
eval "$H_U_CSA8"
if [ "$?" -eq 0 ] ; then
    echo "${GREENCOLOR}PASSED${NOCOLOR}"
else
...
# 4-BIT CARRY SAVE ADDER
${C} ${CFLAGS} ${HIER_ADD_PATH}h_s_csa4.c -o h_s_csa4
TEST_NUM=$((TEST_NUM+1))
echo "TEST_$TEST_NUM: h_s_csa4.c"
eval "$H_S_CSA4"
if [ "$?" -eq 0 ] ; then
    echo "${GREENCOLOR}PASSED${NOCOLOR}"
else
...
# 8-BIT CARRY SAVE ADDER
${C} ${CFLAGS} ${HIER_ADD_PATH}h_s_csa8.c -o h_s_csa8
TEST_NUM=$((TEST_NUM+1))
echo "TEST_$TEST_NUM: h_s_csa8.c"
eval "$H_S_CSA8"
if [ "$?" -eq 0 ] ; then
    echo "${GREENCOLOR}PASSED${NOCOLOR}"
else
...
# 4-BIT DADDA-CSA MULTIPLIER
${C} ${CFLAGS} ${HIER_MUL_PATH}h_u_dadda_csa4.c -o h_u_dadda_csa4
TEST_NUM=$((TEST_NUM+1))
echo "TEST_$TEST_NUM: h_u_dadda_csa4.c"
eval "$H_U_DADDA_CSA4"
if [ "$?" -eq 0 ] ; then
    echo "${GREENCOLOR}PASSED${NOCOLOR}"
else
...
# 8-BIT DADDA-CSA MULTIPLIER
${C} ${CFLAGS} ${HIER_MUL_PATH}h_u_dadda_csa8.c -o h_u_dadda_csa8
TEST_NUM=$((TEST_NUM+1))
echo "TEST_$TEST_NUM: h_u_dadda_csa8.c"
eval "$H_U_DADDA_CSA8"
if [ "$?" -eq 0 ] ; then
    echo "${GREENCOLOR}PASSED${NOCOLOR}"
else
...
# 4-BIT WALLACE-CSA MULTIPLIER
${C} ${CFLAGS} ${HIER_MUL_PATH}h_u_wallace_csa4.c -o h_u_wallace_csa4
TEST_NUM=$((TEST_NUM+1))
echo "TEST_$TEST_NUM: h_u_wallace_csa4.c"
eval "$H_U_WALLACE_CSA4"
if [ "$?" -eq 0 ] ; then
    echo "${GREENCOLOR}PASSED${NOCOLOR}"
else
    echo "${REDCOLOR}FAILED${NOCOLOR}"
...
# 8-BIT WALLACE-CSA MULTIPLIER
${C} ${CFLAGS} ${HIER_MUL_PATH}h_u_wallace_csa8.c -o h_u_wallace_csa8
TEST_NUM=$((TEST_NUM+1))
echo "TEST_$TEST_NUM: h_u_wallace_csa8.c"
eval "$H_U_WALLACE_CSA8"
if [ "$?" -eq 0 ] ; then
    echo "${GREENCOLOR}PASSED${NOCOLOR}"
else
    echo "${REDCOLOR}FAILED${NOCOLOR}"
...
# 4-BIT DADDA-CSA MULTIPLIER
${C} ${CFLAGS} ${HIER_MUL_PATH}h_s_dadda_csa4.c -o h_s_dadda_csa4
TEST_NUM=$((TEST_NUM+1))
echo "TEST_$TEST_NUM: h_s_dadda_csa4.c"
eval "$H_S_DADDA_CSA4"
if [ "$?" -eq 0 ] ; then
    echo "${GREENCOLOR}PASSED${NOCOLOR}"
else
...
# 8-BIT DADDA-CSA MULTIPLIER
${C} ${CFLAGS} ${HIER_MUL_PATH}h_s_dadda_csa8.c -o h_s_dadda_csa8
TEST_NUM=$((TEST_NUM+1))
echo "TEST_$TEST_NUM: h_s_dadda_csa8.c"
eval "$H_S_DADDA_CSA8"
if [ "$?" -eq 0 ] ; then
    echo "${GREENCOLOR}PASSED${NOCOLOR}"
else
...
# 4-BIT WALLACE-CSA MULTIPLIER
${C} ${CFLAGS} ${HIER_MUL_PATH}h_s_wallace_csa4.c -o h_s_wallace_csa4
TEST_NUM=$((TEST_NUM+1))
echo "TEST_$TEST_NUM: h_s_wallace_csa4.c"
eval "$H_S_WALLACE_CSA4"
if [ "$?" -eq 0 ] ; then
    echo "${GREENCOLOR}PASSED${NOCOLOR}"
else
    echo "${REDCOLOR}FAILED${NOCOLOR}"
...
# 8-BIT WALLACE-CSA MULTIPLIER
${C} ${CFLAGS} ${HIER_MUL_PATH}h_s_wallace_csa8.c -o h_s_wallace_csa8
TEST_NUM=$((TEST_NUM+1))
echo "TEST_$TEST_NUM: h_s_wallace_csa8.c"
eval "$H_S_WALLACE_CSA8"
if [ "$?" -eq 0 ] ; then
    echo "${GREENCOLOR}PASSED${NOCOLOR}"
else
    echo "${REDCOLOR}FAILED${NOCOLOR}"
