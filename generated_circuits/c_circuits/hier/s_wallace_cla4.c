...
int64_t s_wallace_cla4(int64_t a, int64_t b){
  ...
  uint64_t s_wallace_cla4_u_cla6_a = 0;
  uint64_t s_wallace_cla4_u_cla6_b = 0;
  uint64_t s_wallace_cla4_u_cla6_out = 0;
  uint8_t s_wallace_cla4_xor0 = 0;

  s_wallace_cla4_and_2_0 = and_gate(((a >> 2) & 0x01), ((b >> 0) & 0x01));
  s_wallace_cla4_and_1_1 = and_gate(((a >> 1) & 0x01), ((b >> 1) & 0x01));
  s_wallace_cla4_ha0_xor0 = (ha(((s_wallace_cla4_and_2_0 >> 0) & 0x01), ((s_wallace_cla4_and_1_1 >> 0) & 0x01)) >> 0) & 0x01;
  s_wallace_cla4_ha0_and0 = (ha(((s_wallace_cla4_and_2_0 >> 0) & 0x01), ((s_wallace_cla4_and_1_1 >> 0) & 0x01)) >> 1) & 0x01;
  s_wallace_cla4_nand_3_0 = nand_gate(((a >> 3) & 0x01), ((b >> 0) & 0x01));
  s_wallace_cla4_and_2_1 = and_gate(((a >> 2) & 0x01), ((b >> 1) & 0x01));
  s_wallace_cla4_fa0_xor1 = (fa(((s_wallace_cla4_ha0_and0 >> 0) & 0x01), ((s_wallace_cla4_nand_3_0 >> 0) & 0x01), ((s_wallace_cla4_and_2_1 >> 0) & 0x01)) >> 0) & 0x01;
  s_wallace_cla4_fa0_or0 = (fa(((s_wallace_cla4_ha0_and0 >> 0) & 0x01), ((s_wallace_cla4_nand_3_0 >> 0) & 0x01), ((s_wallace_cla4_and_2_1 >> 0) & 0x01)) >> 1) & 0x01;
  s_wallace_cla4_nand_3_1 = nand_gate(((a >> 3) & 0x01), ((b >> 1) & 0x01));
  s_wallace_cla4_fa1_xor1 = (fa(((s_wallace_cla4_fa0_or0 >> 0) & 0x01), (0x01), ((s_wallace_cla4_nand_3_1 >> 0) & 0x01)) >> 0) & 0x01;
  s_wallace_cla4_fa1_or0 = (fa(((s_wallace_cla4_fa0_or0 >> 0) & 0x01), (0x01), ((s_wallace_cla4_nand_3_1 >> 0) & 0x01)) >> 1) & 0x01;
  s_wallace_cla4_and_1_2 = and_gate(((a >> 1) & 0x01), ((b >> 2) & 0x01));
  s_wallace_cla4_nand_0_3 = nand_gate(((a >> 0) & 0x01), ((b >> 3) & 0x01));
  s_wallace_cla4_ha1_xor0 = (ha(((s_wallace_cla4_and_1_2 >> 0) & 0x01), ((s_wallace_cla4_nand_0_3 >> 0) & 0x01)) >> 0) & 0x01;
  s_wallace_cla4_ha1_and0 = (ha(((s_wallace_cla4_and_1_2 >> 0) & 0x01), ((s_wallace_cla4_nand_0_3 >> 0) & 0x01)) >> 1) & 0x01;
  s_wallace_cla4_and_2_2 = and_gate(((a >> 2) & 0x01), ((b >> 2) & 0x01));
  s_wallace_cla4_nand_1_3 = nand_gate(((a >> 1) & 0x01), ((b >> 3) & 0x01));
  s_wallace_cla4_fa2_xor1 = (fa(((s_wallace_cla4_ha1_and0 >> 0) & 0x01), ((s_wallace_cla4_and_2_2 >> 0) & 0x01), ((s_wallace_cla4_nand_1_3 >> 0) & 0x01)) >> 0) & 0x01;
  s_wallace_cla4_fa2_or0 = (fa(((s_wallace_cla4_ha1_and0 >> 0) & 0x01), ((s_wallace_cla4_and_2_2 >> 0) & 0x01), ((s_wallace_cla4_nand_1_3 >> 0) & 0x01)) >> 1) & 0x01;
  s_wallace_cla4_nand_3_2 = nand_gate(((a >> 3) & 0x01), ((b >> 2) & 0x01));
  s_wallace_cla4_fa3_xor1 = (fa(((s_wallace_cla4_fa2_or0 >> 0) & 0x01), ((s_wallace_cla4_fa1_or0 >> 0) & 0x01), ((s_wallace_cla4_nand_3_2 >> 0) & 0x01)) >> 0) & 0x01;
  s_wallace_cla4_fa3_or0 = (fa(((s_wallace_cla4_fa2_or0 >> 0) & 0x01), ((s_wallace_cla4_fa1_or0 >> 0) & 0x01), ((s_wallace_cla4_nand_3_2 >> 0) & 0x01)) >> 1) & 0x01;
  s_wallace_cla4_and_0_0 = and_gate(((a >> 0) & 0x01), ((b >> 0) & 0x01));
  s_wallace_cla4_and_1_0 = and_gate(((a >> 1) & 0x01), ((b >> 0) & 0x01));
  s_wallace_cla4_and_0_2 = and_gate(((a >> 0) & 0x01), ((b >> 2) & 0x01));
  s_wallace_cla4_nand_2_3 = nand_gate(((a >> 2) & 0x01), ((b >> 3) & 0x01));
  s_wallace_cla4_and_0_1 = and_gate(((a >> 0) & 0x01), ((b >> 1) & 0x01));
  s_wallace_cla4_and_3_3 = and_gate(((a >> 3) & 0x01), ((b >> 3) & 0x01));
  s_wallace_cla4_u_cla6_a |= ((s_wallace_cla4_and_1_0 >> 0) & 0x01ull) << 0;
  s_wallace_cla4_u_cla6_a |= ((s_wallace_cla4_and_0_2 >> 0) & 0x01ull) << 1;
  s_wallace_cla4_u_cla6_a |= ((s_wallace_cla4_fa0_xor1 >> 0) & 0x01ull) << 2;
  s_wallace_cla4_u_cla6_a |= ((s_wallace_cla4_fa1_xor1 >> 0) & 0x01ull) << 3;
  s_wallace_cla4_u_cla6_a |= ((s_wallace_cla4_nand_2_3 >> 0) & 0x01ull) << 4;
  s_wallace_cla4_u_cla6_a |= ((s_wallace_cla4_fa3_or0 >> 0) & 0x01ull) << 5;
  s_wallace_cla4_u_cla6_b |= ((s_wallace_cla4_and_0_1 >> 0) & 0x01ull) << 0;
  s_wallace_cla4_u_cla6_b |= ((s_wallace_cla4_ha0_xor0 >> 0) & 0x01ull) << 1;
  s_wallace_cla4_u_cla6_b |= ((s_wallace_cla4_ha1_xor0 >> 0) & 0x01ull) << 2;
  s_wallace_cla4_u_cla6_b |= ((s_wallace_cla4_fa2_xor1 >> 0) & 0x01ull) << 3;
  s_wallace_cla4_u_cla6_b |= ((s_wallace_cla4_fa3_xor1 >> 0) & 0x01ull) << 4;
  s_wallace_cla4_u_cla6_b |= ((s_wallace_cla4_and_3_3 >> 0) & 0x01ull) << 5;
  s_wallace_cla4_u_cla6_out = u_cla6(s_wallace_cla4_u_cla6_a, s_wallace_cla4_u_cla6_b);
  s_wallace_cla4_xor0 = not_gate(((s_wallace_cla4_u_cla6_out >> 6) & 0x01));

  s_wallace_cla4_out |= ((s_wallace_cla4_and_0_0 >> 0) & 0x01ull) << 0;
  s_wallace_cla4_out |= ((s_wallace_cla4_u_cla6_out >> 0) & 0x01ull) << 1;
  s_wallace_cla4_out |= ((s_wallace_cla4_u_cla6_out >> 1) & 0x01ull) << 2;
  s_wallace_cla4_out |= ((s_wallace_cla4_u_cla6_out >> 2) & 0x01ull) << 3;
  s_wallace_cla4_out |= ((s_wallace_cla4_u_cla6_out >> 3) & 0x01ull) << 4;
  s_wallace_cla4_out |= ((s_wallace_cla4_u_cla6_out >> 4) & 0x01ull) << 5;
  s_wallace_cla4_out |= ((s_wallace_cla4_u_cla6_out >> 5) & 0x01ull) << 6;
