...
uint64_t h_s_wallace_rca8(uint64_t a, uint64_t b){
  ...
  uint64_t h_s_wallace_rca8_u_rca_u_rca_a = 0;
  uint64_t h_s_wallace_rca8_u_rca_u_rca_b = 0;
  uint64_t h_s_wallace_rca8_u_rca_out = 0;
  uint8_t h_s_wallace_rca8_u_rca_ha_y0 = 0;
  uint8_t h_s_wallace_rca8_u_rca_fa1_y2 = 0;
  uint8_t h_s_wallace_rca8_u_rca_fa2_y2 = 0;
  uint8_t h_s_wallace_rca8_u_rca_fa3_y2 = 0;
  uint8_t h_s_wallace_rca8_u_rca_fa4_y2 = 0;
  uint8_t h_s_wallace_rca8_u_rca_fa5_y2 = 0;
  uint8_t h_s_wallace_rca8_u_rca_fa6_y2 = 0;
  uint8_t h_s_wallace_rca8_u_rca_fa7_y2 = 0;
  uint8_t h_s_wallace_rca8_u_rca_fa8_y2 = 0;
  uint8_t h_s_wallace_rca8_u_rca_fa9_y2 = 0;
  uint8_t h_s_wallace_rca8_u_rca_fa10_y2 = 0;
  uint8_t h_s_wallace_rca8_u_rca_fa11_y2 = 0;
  uint8_t h_s_wallace_rca8_u_rca_fa12_y2 = 0;
  uint8_t h_s_wallace_rca8_u_rca_fa13_y2 = 0;
  uint8_t h_s_wallace_rca8_u_rca_fa13_y4 = 0;
  ...
  h_s_wallace_rca8_u_rca_u_rca_a |= (h_s_wallace_rca8_and_1_0_y0 & 0x01) << 0;
  h_s_wallace_rca8_u_rca_u_rca_a |= (h_s_wallace_rca8_and_0_2_y0 & 0x01) << 1;
  h_s_wallace_rca8_u_rca_u_rca_a |= (h_s_wallace_rca8_fa0_y2 & 0x01) << 2;
  h_s_wallace_rca8_u_rca_u_rca_a |= (h_s_wallace_rca8_fa10_y2 & 0x01) << 3;
  h_s_wallace_rca8_u_rca_u_rca_a |= (h_s_wallace_rca8_fa18_y2 & 0x01) << 4;
  h_s_wallace_rca8_u_rca_u_rca_a |= (h_s_wallace_rca8_fa24_y2 & 0x01) << 5;
  h_s_wallace_rca8_u_rca_u_rca_a |= (h_s_wallace_rca8_fa28_y2 & 0x01) << 6;
  h_s_wallace_rca8_u_rca_u_rca_a |= (h_s_wallace_rca8_fa29_y2 & 0x01) << 7;
  h_s_wallace_rca8_u_rca_u_rca_a |= (h_s_wallace_rca8_fa27_y2 & 0x01) << 8;
  h_s_wallace_rca8_u_rca_u_rca_a |= (h_s_wallace_rca8_fa23_y2 & 0x01) << 9;
  h_s_wallace_rca8_u_rca_u_rca_a |= (h_s_wallace_rca8_fa17_y2 & 0x01) << 10;
  h_s_wallace_rca8_u_rca_u_rca_a |= (h_s_wallace_rca8_fa9_y2 & 0x01) << 11;
  h_s_wallace_rca8_u_rca_u_rca_a |= (h_s_wallace_rca8_nand_6_7_y0 & 0x01) << 12;
  h_s_wallace_rca8_u_rca_u_rca_a |= (h_s_wallace_rca8_fa35_y4 & 0x01) << 13;
  h_s_wallace_rca8_u_rca_u_rca_b |= (h_s_wallace_rca8_and_0_1_y0 & 0x01) << 0;
  h_s_wallace_rca8_u_rca_u_rca_b |= (h_s_wallace_rca8_ha0_y0 & 0x01) << 1;
  h_s_wallace_rca8_u_rca_u_rca_b |= (h_s_wallace_rca8_ha1_y0 & 0x01) << 2;
  h_s_wallace_rca8_u_rca_u_rca_b |= (h_s_wallace_rca8_ha2_y0 & 0x01) << 3;
  h_s_wallace_rca8_u_rca_u_rca_b |= (h_s_wallace_rca8_ha3_y0 & 0x01) << 4;
  h_s_wallace_rca8_u_rca_u_rca_b |= (h_s_wallace_rca8_ha4_y0 & 0x01) << 5;
  h_s_wallace_rca8_u_rca_u_rca_b |= (h_s_wallace_rca8_ha5_y0 & 0x01) << 6;
  h_s_wallace_rca8_u_rca_u_rca_b |= (h_s_wallace_rca8_fa30_y2 & 0x01) << 7;
  h_s_wallace_rca8_u_rca_u_rca_b |= (h_s_wallace_rca8_fa31_y2 & 0x01) << 8;
  h_s_wallace_rca8_u_rca_u_rca_b |= (h_s_wallace_rca8_fa32_y2 & 0x01) << 9;
  h_s_wallace_rca8_u_rca_u_rca_b |= (h_s_wallace_rca8_fa33_y2 & 0x01) << 10;
  h_s_wallace_rca8_u_rca_u_rca_b |= (h_s_wallace_rca8_fa34_y2 & 0x01) << 11;
  h_s_wallace_rca8_u_rca_u_rca_b |= (h_s_wallace_rca8_fa35_y2 & 0x01) << 12;
  h_s_wallace_rca8_u_rca_u_rca_b |= (h_s_wallace_rca8_and_7_7_y0 & 0x01) << 13;
  h_s_wallace_rca8_u_rca_out = u_rca(h_s_wallace_rca8_u_rca_u_rca_a, h_s_wallace_rca8_u_rca_u_rca_b);
  h_s_wallace_rca8_u_rca_ha_y0 = ((h_s_wallace_rca8_u_rca_out >> 0) & 0x01);
  h_s_wallace_rca8_u_rca_fa1_y2 = ((h_s_wallace_rca8_u_rca_out >> 1) & 0x01);
  h_s_wallace_rca8_u_rca_fa2_y2 = ((h_s_wallace_rca8_u_rca_out >> 2) & 0x01);
  h_s_wallace_rca8_u_rca_fa3_y2 = ((h_s_wallace_rca8_u_rca_out >> 3) & 0x01);
  h_s_wallace_rca8_u_rca_fa4_y2 = ((h_s_wallace_rca8_u_rca_out >> 4) & 0x01);
  h_s_wallace_rca8_u_rca_fa5_y2 = ((h_s_wallace_rca8_u_rca_out >> 5) & 0x01);
  h_s_wallace_rca8_u_rca_fa6_y2 = ((h_s_wallace_rca8_u_rca_out >> 6) & 0x01);
  h_s_wallace_rca8_u_rca_fa7_y2 = ((h_s_wallace_rca8_u_rca_out >> 7) & 0x01);
  h_s_wallace_rca8_u_rca_fa8_y2 = ((h_s_wallace_rca8_u_rca_out >> 8) & 0x01);
  h_s_wallace_rca8_u_rca_fa9_y2 = ((h_s_wallace_rca8_u_rca_out >> 9) & 0x01);
  h_s_wallace_rca8_u_rca_fa10_y2 = ((h_s_wallace_rca8_u_rca_out >> 10) & 0x01);
  h_s_wallace_rca8_u_rca_fa11_y2 = ((h_s_wallace_rca8_u_rca_out >> 11) & 0x01);
  h_s_wallace_rca8_u_rca_fa12_y2 = ((h_s_wallace_rca8_u_rca_out >> 12) & 0x01);
  h_s_wallace_rca8_u_rca_fa13_y2 = ((h_s_wallace_rca8_u_rca_out >> 13) & 0x01);
  h_s_wallace_rca8_u_rca_fa13_y4 = ((h_s_wallace_rca8_u_rca_out >> 14) & 0x01);
  h_s_wallace_rca8_xor0_y0 = xor_gate(constant_wire_1, h_s_wallace_rca8_u_rca_fa13_y4);

  out |= (h_s_wallace_rca8_and_0_0_y0 & 0x01) << 0;
  out |= (h_s_wallace_rca8_u_rca_ha_y0 & 0x01) << 1;
  out |= (h_s_wallace_rca8_u_rca_fa1_y2 & 0x01) << 2;
  out |= (h_s_wallace_rca8_u_rca_fa2_y2 & 0x01) << 3;
  out |= (h_s_wallace_rca8_u_rca_fa3_y2 & 0x01) << 4;
  out |= (h_s_wallace_rca8_u_rca_fa4_y2 & 0x01) << 5;
  out |= (h_s_wallace_rca8_u_rca_fa5_y2 & 0x01) << 6;
  out |= (h_s_wallace_rca8_u_rca_fa6_y2 & 0x01) << 7;
  out |= (h_s_wallace_rca8_u_rca_fa7_y2 & 0x01) << 8;
  out |= (h_s_wallace_rca8_u_rca_fa8_y2 & 0x01) << 9;
  out |= (h_s_wallace_rca8_u_rca_fa9_y2 & 0x01) << 10;
  out |= (h_s_wallace_rca8_u_rca_fa10_y2 & 0x01) << 11;
  out |= (h_s_wallace_rca8_u_rca_fa11_y2 & 0x01) << 12;
  out |= (h_s_wallace_rca8_u_rca_fa12_y2 & 0x01) << 13;
  out |= (h_s_wallace_rca8_u_rca_fa13_y2 & 0x01) << 14;
